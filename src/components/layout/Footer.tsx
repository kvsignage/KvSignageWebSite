...
export function Footer() {
  return (
    <footer className="border-t border-gray-800/30 bg-gray-950/50">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-10">
          ...
          <div className="space-y-5">
            ...
            <p className="text-gray-400 text-sm leading-relaxed">
              Chennai&apos;s trusted signage partner. Premium LED boards, neon signs, 
              ACP letters, and more. Making businesses shine since 2018.
            </p>
            <div className="flex gap-4 pt-1">
              <a href={siteConfig.social.instagram} target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-gold transition-colors" aria-label="Instagram">
              ...
              <a href={siteConfig.social.facebook} target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-gold transition-colors" aria-label="Facebook">
                <svg className="w-[18px] h-[18px]" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
              </a>
              {/* <a href={siteConfig.social.youtube} target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-gold transition-colors" aria-label="YouTube">
          ...
          {/* Services */}
          <div>
            <h3 className="text-white font-medium text-sm mb-5">Services</h3>
            <ul className="space-y-3">
              {services.slice(0, 5).map((service) => (
                <li key={service.slug}>
                  <Link href={`/services/${service.slug}`} className="text-gray-400 text-sm hover:text-gold transition-colors">
                    {service.title}
                  </Link>
                </li>
              ))}
          ...
          {/* Contact */}
          <div>
            <h3 className="text-white font-medium text-sm mb-5">Contact Us</h3>
